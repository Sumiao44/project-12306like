...
package org.project12306.commons.web.initialize;
...
import static org.project12306.commons.web.config.WebAutoConfiguration.INITIALIZE_PATH;
...
public final class InitializeDispatcherServletHandler implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        String url = String.format("http://192.168.153.135:%s%s",
