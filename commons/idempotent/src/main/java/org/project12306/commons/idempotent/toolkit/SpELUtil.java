...
package org.project12306.commons.idempotent.toolkit;
...
public class SpELUtil {
    ...
    /**
     * 校验并返回实际使用的 spEL 表达式
     * 因为注解中我们指定的key都是方法，比如
     * T(org.project12306.commons.user.core.UserContext).getUsername()
     * 所以这里就要根据传入的参数名来获取真正的参数作为去重表的唯一索引
     * @param spEl spEL 表达式
     * @param method 被注解的方法
     * @param contextObj 被注解的方法的参数列表
    ...
    public static Object parse(String spEl, Method method, Object[] contextObj) {
        ...
        // 4. 获取方法参数名（如 ["order", "userId"]）
        String[] params = discoverer.getParameterNames(method);

        // 5. 创建 SpEL 上下文，绑定参数名与参数值
