...
package org.project12306.commons.common.threadpool.build;

import org.project12306.commons.common.toolkit.Assert;
import org.project12306.commons.desingnpattern.builder.Builder;
...
public final class ThreadPoolBuilder implements Builder<ThreadPoolExecutor> {
    ...
    /**
     * 线程池数量为核心线程数+核心线程数/2代表最大临时线程树为核心线程数/2
     */
    ...
    public ThreadPoolExecutor build() {
        ...
        //通过阿里巴巴推荐的threadpoolexecutor创建线程池
